...
CREATE TABLE ESTADO_ARTICULO(
	ID_ESTADO INT CONSTRAINT PK_IDEST_EST PRIMARY KEY IDENTITY (1, 1) NOT NULL,
...
CREATE TABLE ARTICULO (
	...
	ID_ESTADO INT CONSTRAINT FK_IDEST_ART_EST FOREIGN KEY REFERENCES ESTADO(ID_ESTADO) ON DELETE SET NULL ON UPDATE CASCADE
